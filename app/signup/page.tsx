    ...
    <div className="min-h-screen bg-[#FFF8F0] pb-16">
      ...
      <div className="bg-[#6B1E2E] px-4 pt-10 pb-20">
        <div className="max-w-md mx-auto">
          ...
          <h1 className="font-heading text-4xl font-bold text-white">Create Account</h1>
          <p className="text-white/60 text-sm mt-1">Earn points on every order</p>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto px-4 -mt-10">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#F0E4D8]">
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link href="/login" className="text-[#6B1E2E] font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
